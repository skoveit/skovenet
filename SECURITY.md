...
| **Severity**      | **Reward**                     |
| ----------------- | ------------------------------ |
| **Critical**      | **Precious Bait**              |
| **High**          | **Remembrance of the Grafted** |
| **Medium**        | **A Much Bigger Thanks**       |
| **Low**           | **A Big Thanks**               |
| **Informational** | **A Thanks**                   |
### Reporting a Vulnerability
Please report any identified vulnerability via GitHub's private [report a vulnerability feature](https://github.com/skoveit/skovenet/security/advisories/new).
